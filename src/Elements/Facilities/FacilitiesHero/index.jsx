        ...
        <Row gutter={[16, 16]} align="middle">
          ...
          <Col xs={24} md={12}>
            ...
            <p className="mt-4 text-lg leading-relaxed text-black">
              At Brajesh Mishra Classes, our facilities are designed to inspire learning and growth. With modern amenities and a supportive environment, we ensure every student has the tools they need to succeed.
            </p>
            <div className="mt-6">
              <Link to="/contact-us">
                <Button
          ...
          <Col xs={24} md={12}>
            <div className="flex justify-center">
              <img
                src="/bmc2.jpeg" // Replace with your actual image URL
                alt="Facilities"
